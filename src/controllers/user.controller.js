    ...
    const channel = await User.aggregate([
        {
            ...
            $lookup: {                  //MongoDB’s version of SQL JOIN.
                from: "subscriptions",  //Join with the subscriptions collection.
                localField: "_id",      //The field in the CURRENT collection (User collection in your case).
                foreignField: "channel", //The field in the subscriptions collection.
                as: "subscribers"        //Store the matched results inside a new field called "subscribers".
            }
        },
        {
            $lookup: {
